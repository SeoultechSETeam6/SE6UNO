...
class SinglePlay:
    def __init__(self, computer_attends, username):
        ...
        # 게임 이미지를 로드
        self.pause_button_img = basic.scale_by(pygame.image.load(
            "../resources/Image/button_images/pause.png").convert_alpha(), self.size_change)
        self.resume_button_img = basic.scale_by(pygame.image.load(
            "../resources/Image/button_images/resume.png").convert_alpha(), self.size_change)
        self.direction_img = basic.scale_by(pygame.image.load(
        ...
        self.turn_arrow_img = basic.scale_by(pygame.image.load(
            "../resources/Image/direction_images/turn_arrow.png").convert_alpha(), self.size_change)
        self.next_turn_button_img = basic.scale_by(pygame.image.load(
            "../resources/Image/button_images/next_turn.png").convert_alpha(), self.size_change)
        self.uno_button_img = basic.scale_by(pygame.image.load(
    ...
    def draw_2_animation(self, index):
        self.draw()
        self.screen.blit(basic.scale_by(pygame.image.load("../resources/Image/animation/+2.png"), self.size_change), (self.center_x, self.center_y))
        pygame.display.flip()
        time.sleep(0.7)
    ...
    def bomb_animation(self, index):
        self.draw()
        self.screen.blit(basic.scale_by(pygame.image.load("../resources/Image/animation/bomb.png"), self.size_change), (self.center_x, self.center_y))
        pygame.display.flip()
        time.sleep(0.7)
        remain_pos = [pygame.Vector2(self.remain_cards_x_position, self.screen.get_rect().centery - 100)]
        self.card_place_music.set_volume(self.sound_volume * self.effect_volume)
    ...
    def reverse_animation(self, index):
        self.draw()
        self.screen.blit(basic.scale_by(pygame.image.load("../resources/Image/animation/reverse.png"), self.size_change), (self.center_x, self.center_y))
        pygame.display.flip()
        time.sleep(0.7)
    ...
    def skip_animation(self, index):
        ...
        if index == 0:
            ...
            pos = pygame.Vector2(self.computer_coordinate[4][0] - self.turn_coordinate[2],
                                 self.computer_coordinate[4][1] - self.turn_coordinate[3])
        self.draw()
        self.screen.blit(basic.scale_by(pygame.image.load("../resources/Image/animation/skip.png"), self.size_change), pos)
        pygame.display.flip()
        time.sleep(0.7)

    def one_more_animation(self, index):
        self.draw()
        self.screen.blit(basic.scale_by(pygame.image.load("./resources/Image/animation/-1.png"), self.size_change), (self.center_x, self.center_y))
        pygame.display.flip()
        time.sleep(0.7)
